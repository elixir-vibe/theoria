...
- Added Elixir-authored kernel spec metadata, a reference checker for core terms, a reference normalizer, Bool/Nat/List/Vec corpus cases, rejection/theorem-corpus differential checks, and `mix theoria.kernel.check`.

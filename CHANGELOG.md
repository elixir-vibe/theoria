...
- Added Elixir-authored kernel spec metadata, a reference checker for core terms, a reference normalizer, rejection/theorem-corpus differential checks, and `mix theoria.kernel.check`.

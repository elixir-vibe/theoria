...
| Matcher.Type | Plans descriptor-derived `Matcher.Type.Shape` values with parameters, motive, discriminants, alternatives, result, and body, then folds simple telescopes; not a general dependent matcher compiler. |

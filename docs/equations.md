...
| Matcher.Type | Plans descriptor-derived `Matcher.Type.Shape` values and emits current simple recursor shapes; not a general dependent matcher compiler. |

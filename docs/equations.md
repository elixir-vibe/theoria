...
| Matcher.Descriptor | Recursor-informed Bool/Nat/List descriptors plus indexed Vec-like descriptor shape; dependent/indexed matcher type/body generation is still unsupported. |

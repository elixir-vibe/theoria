defmodule Theoria.Equation.Case.Template do
  @moduledoc "Experimental/internal API for 0.2; subject to change before 0.3. Schematic equation case template used by schema generation."

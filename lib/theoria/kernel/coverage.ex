defmodule Theoria.Kernel.Coverage do
  ...
  def summary(%Env{} = env, %Report{} = report) do
    ...
    %{
      ...
      generated_term_checks: report.generated_terms.total,
      generated_term_families: report.generated_terms.families,
      ...
      proof_strategy_counts: report.proof_strategies.counts,

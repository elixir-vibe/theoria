defmodule Theoria.Validation.Report do
  ...
  @enforce_keys [:categories, :theorem_count, :defeq_count, :inductive_count, :equations, :axioms]
  defstruct [:categories, :theorem_count, :defeq_count, :inductive_count, :equations, :axioms]

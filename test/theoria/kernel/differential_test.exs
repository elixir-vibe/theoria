defmodule Theoria.Kernel.DifferentialTest do
  ...
  test "reference checker agrees with production kernel on the curated corpus" do
    ...
    assert report.generated_terms.families.bool > 0
    assert report.generated_terms.families.nat_eq_rec > 0
    assert report.generated_terms.families.nat_let > 0
    assert report.generated_terms.families.bool_forall > 0
    assert report.generated_terms.families.bool_refl > 0
    assert report.generated_terms.families.bool_eq_rec > 0
    assert report.generated_terms.families.bool_beta > 0
    assert report.generated_terms.families.nat_beta > 0
